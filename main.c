...
/*   Updated: 2023/03/14 19:17:06 by aantonio         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	// ft_printf("\n");
	// ft_put_ull(21, "0123456789abcdef");
	// ft_printf("\n");
	// ft_put_ull(22, "0123456789abcdef");
	// ft_printf("\n");
	// ft_put_ull(23, "0123456789abcdef");
	// ft_printf("\n");
	// ft_put_ull(24, "0123456789abcdef");
	// ft_printf("\n");
	// ft_put_ull(25, "0123456789abcdef");
	// ft_printf("\n");
	// ft_put_ull(26, "0123456789abcdef");
	// ft_printf("\n");
	// ft_put_ull(27, "0123456789abcdef");
	// ft_printf("\n");
	// ft_put_ull(28, "0123456789abcdef");
	// ft_printf("\n");
	// ft_put_ull(29, "0123456789abcdef");
	// ft_printf("\n");
	...
	// ft_printf("\n");
	// ft_put_ull(31261331, "0123456789abcdef");
	ft_printf("\n");
	ft_printf("\n");
	ft_printf("\n");
	ft_printf(" %p ", -1);
